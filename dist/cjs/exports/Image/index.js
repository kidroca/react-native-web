...
var useSource = (callbacks, source) => {
  ...
  React.useEffect(() => {
    ...
    function handleLoad(nativeEvent) {
      ...
      setStatus(LOADED);
      setResult((0, _objectSpread2.default)((0, _objectSpread2.default)({}, resolvedSource), nativeEvent.source));
    }
    ...
    var requestId = _ImageLoader.default.load(resolvedSource, handleLoad, handleError); // Release resources on unmount or after starting a new request


    return () => _ImageLoader.default.abort(requestId);
  }, [resolvedSource]);
  return {
    status,
    source: result
