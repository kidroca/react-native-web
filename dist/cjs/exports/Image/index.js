...
var BaseImage = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  var isCached = uri != null && _ImageLoader.default.has(uri);
  ...
  React.useEffect(() => {
    ...
    function abortPendingRequest() {
      if (requestRef.current != null) {
        _ImageLoader.default.clear(requestRef.current);
...
var ImageWithHeaders = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  React.useEffect(() => {
    ...
    request.current = _ImageLoader.default.loadWithHeaders(nextSource);
  ...
  var propsToPass = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
    ...
    source: blobUri ? (0, _objectSpread2.default)((0, _objectSpread2.default)({}, nextSource), {}, {
      uri: blobUri
    }) : undefined
  });
  return /*#__PURE__*/React.createElement(BaseImage, (0, _extends2.default)({
    ref: ref
  }, propsToPass));
...
var ImageWithStatics = /*#__PURE__*/React.forwardRef((props, ref) => {
  if (props.source && props.source.headers) {
    return /*#__PURE__*/React.createElement(ImageWithHeaders, (0, _extends2.default)({
      ref: ref
    }, props));
  }
