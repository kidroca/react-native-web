...
var useSource = (callbacks, source) => {
  ...
  React.useEffect(() => {
    ...
    function handleLoad(result) {
      ...
      setStatus(LOADED);
      setResult(_objectSpread(_objectSpread({}, resolvedSource), result.source));
    }
    ...
    setStatus(LOADING);
    var requestId = ImageLoader.load(resolvedSource, handleLoad, handleError); // Release resources on umount or after starting a new request
